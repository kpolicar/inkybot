...
namespace Inkybot.Dofus
{
    public class DefaultStatConfigProvider : StatConfigProvider
    {
        ...
        private Dictionary<Stat, StatConfig> defaultConfig = new Dictionary<Stat, StatConfig> {
            ...
            {Stat.CriticalResistance, new StatConfig(17, 14)},
            {Stat.PushbackResistance, new StatConfig(17, 14)},
            {Stat.Power, new StatConfig(21, 17, 54, 50)},
            {Stat.PowerTraps, new StatConfig(21, 17, 54, 50)},
            {Stat.NeutralResistance, new StatConfig(17, 14)},
            {Stat.EarthResistance, new StatConfig(17, 14)},
            {Stat.FireResistance, new StatConfig(17, 14)},
            {Stat.AirResistance, new StatConfig(17, 14)},
            {Stat.WaterResistance, new StatConfig(17, 14)},
            ...
            {Stat.NeutralDamage, new StatConfig(17, 14)},
            {Stat.EarthDamage, new StatConfig(17, 14)},
            {Stat.FireDamage, new StatConfig(17, 14)},
            {Stat.AirDamage, new StatConfig(17, 14)},
            {Stat.WaterDamage, new StatConfig(17, 14)},
            {Stat.CriticalDamage, new StatConfig(17, 14)},
            {Stat.PushbackDamage, new StatConfig(17, 14)},
            {Stat.TrapDamage, new StatConfig(17, 14)},
